...
public class dbCocktails extends SQLiteOpenHelper {
	
    private static final String DB_NAME = "cocktail.db";
    private static final String DB_PATH = "/data/data/luca.general.cocktail/databases/";
